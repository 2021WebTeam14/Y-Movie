		...
		<div class="container">
			...
			<p id="avatarID">Profile picture:</p>
				<ul id="avatarList" style="text-align: center;">
					...
					<li>
						<img alt="avatar3" id="avatar3" class="normal" src="img/moon.jpg">
						<input type="radio" name="avatar" value="3">
					</li>
					<li>
						<img alt="avatar4" id="avatar4" class="normal" src="img/fire.jpg">
						<input type="radio" name="avatar" value="4">
					</li>
					<li>
						<img alt="avatar5" id="avatar5" class="normal" src="img/watch.jpg">
						<input type="radio" name="avatar" value="5">
					</li>
					<li>
						<img alt="avatar6" id="avatar6" class="normal" src="img/water.jpg">
