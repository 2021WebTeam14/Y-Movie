...
<body>
    ...
    <div class="outer border centered">
    	<div class="centered noMP"><h1>일간(주간) 박스오피스 순위 / 사이트 별점 순위</h1></div>
	    <div class="centered flex">
	    	<div id="arrow">&lt;</div>
			<div class="rank">    	
				<div class="rankNum">1</div>
				<img id="img0" src="https://kobis.or.kr/common/mast/movie/2016/10/thumb_x192/thn_08b4cda6ba9b49bb8f31b79fd0f1af64.jpg" class="rankImg noMP">
				<h1>Name of Movie</h1>
	    	</div>
			<div class="rank">    	
				<div class="rankNum">2</div>
				<img id="img1" src="https://kobis.or.kr/common/mast/movie/2016/10/thumb_x192/thn_08b4cda6ba9b49bb8f31b79fd0f1af64.jpg" class="rankImg noMP">
				<h1>Name of Movie</h1>
	    	</div>
			<div class="rank">    	
				<div class="rankNum">3</div>
				<img id="img2" src="https://kobis.or.kr/common/mast/movie/2016/10/thumb_x192/thn_08b4cda6ba9b49bb8f31b79fd0f1af64.jpg" class="rankImg noMP">
				<h1>Name of Movie</h1>
	    	</div>
	    	<div id="arrow">&gt;</div>
	    </div>
