...
<body>  
	...
	<iframe id="head" src="../header.jsp" style="width: 100%; border: none;"></iframe>
	   <h1 style="text-align: center"> 비밀번호 재설정 </h1> 
	    ...
	    <form style="padding-top: 50px; padding-bottom: 50px;" method="POST" action="../jaeik/resetPwProcess.jsp" onsubmit="return jbSubmit()">
	        <div class="container"> 
		        <div class="inner1">
			        <div class="inner2">        
			        	<div class="loginbox">
							...
							%>
				            <input type="text" id="userID" placeholder="아이디" name="username" value="<%=name%>" readonly>
				        	<label>새로운 비밀번호: </label>
				            <input type="password" id="userPW" placeholder="비밀번호" name="password" required>
				        	<label>새로운 비밀번호 확인: </label> 
				            <input type="password" id="userPW2" placeholder="비밀번호 확인" name="passwordAgain" required>
			        	</div>
